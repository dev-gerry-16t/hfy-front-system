  ...
  const handlerCallGenerateDocument = async (data) => {
    ...
    try {
      const response = await callGlobalActionApi(
        ...
        idRequest,
        API_CONSTANTS.EXTERNAL.GET_DOCUMENT_PROPERTIES,
        "PUT"
      );
  ...
  const handlerCallSignDocument = async (data) => {
    ...
    try {
      const response = await callGlobalActionApi(
        ...
        idRequest,
        API_CONSTANTS.EXTERNAL.SIGN_DOCUMENT,
        "PUT"
      );
      const responseResult =
        isNil(response) === false &&
        ...
        <div className="content-cards">
          {isEmpty(dataDocuments) === false &&
            dataDocuments.map((row) => {
              ...
              return (
                <Card
                  colorDocument={row.canSign == true ? "#eff0f6" : style.color}
                >
