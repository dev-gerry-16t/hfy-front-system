...
import ComponentDetailProperty from "../components/componentDetailProperty";
        ...
        <div className="content-cards">
          <ShortDetail>
            <div className="info-data-property">
              ...
              <div className="item-description">
                <span>Precio Renta (Sín mantenimiento)</span>
...
export default SectionDetailProperty;
