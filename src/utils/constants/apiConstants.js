...
const API_CONSTANTS = {
  ...
  CUSTOMER: {
    ...
    GET_PROPERTY_PICTURES: `${API.CUSTOMER}/property/getPropertyPictures`,
    GET_APPLICANTS_BY_PROPERTY: `${API.CUSTOMER}/property/getApplicantsByProperty`,
    GET_AMENITIES_BY_PROPERTY: `${API.CUSTOMER}/property/getAmenitiesByProperty`,
    GET_DOCUMENTS_BY_PROPERTY: `${API.CUSTOMER}/property/getDocumentsByProperty`,
    GET_ADVISERS_IN_PROPERTY: `${API.CUSTOMER}/property/getAdvisersInProperty`,
  ...
  EXTERNAL: {
    ...
    GET_REQUEST_DOCUMENTS: `${API.EXTERNAL}/request/getRequestDocuments`,
    GET_DOCUMENT_PROPERTIES: `${API.EXTERNAL}/request/getDocumentProperties/`,
    SIGN_DOCUMENT: `${API.EXTERNAL}/request/signDocument/`,
    IS_OP_PAID: `${API.EXTERNAL}/request/isOPPaid`,
  },
  PROPERTY: {
    ...
    REQUEST_POLICY: `${API.PROPERTY}/requestPolicy`,
  },
  ANONYMOUS: {
    GET_CATALOG_ID_TYPES: `${API.API}${API.CATALOGS}/getAllIDTypes`,
    GET_ALL_COUNTRIES: `${API.API}${API.LEADS}/catalog/getAllCountries`,
    GET_ZIP_CODE_ADRESS: `${API.API}/customer/getAdressZipCode`,
    GET_TENANT_BY_ID: `${API.API}/external/getTenantById`,
    GET_OWNER_BY_ID: `${API.API}/external/getOwnerById`,
    SET_TENANT: `${API.API}/external/setTenant/`,
    SET_OWNER: `${API.API}/external/setOwner/`,
    VALIDATE_PROPERTIES: `${API.API}/external/validateProperties`,
    GET_REQUEST_DOCUMENTS: `${API.API}/request/getRequestDocuments`,
    GET_DOCUMENT_PROPERTIES: `${API.API}/external/getDocumentProperties/`,
